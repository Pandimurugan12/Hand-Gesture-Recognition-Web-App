...
if not os.path.exists("data"):
    ...
    #os.makedirs("data/train/04_fist_moved")
    ...
    #os.makedirs("data/train/09_c")
    #os.makedirs("data/train/10_down")
...
while True:
    ...
    count = {'palm': len(os.listdir(directory+"01_palm")),
             ...
             #'fist-moved': len(os.listdir(directory+"/04_fist_moved")),
             ...
             #'c': len(os.listdir(directory+"/09_c")),
             #'down': len(os.listdir(directory+"/10_down"))
            }
    ...
    #    cv2.imwrite(directory+'04_fist_moved/'+str(count['fist-moved'])+'.jpg', roi)
    ...
    if interrupt & 0xFF == ord('6'):
        ...
        #cv2.imwrite(directory+'09_c/'+str(count['c'])+'.jpg', roi)
    #if interrupt & 0xFF == ord('9'):
        #cv2.imwrite(directory+'10_down/'+str(count['down'])+'.jpg', roi)
